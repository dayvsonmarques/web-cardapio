...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Catálogo",
    subItems: [
      { name: "Produtos", path: "/admin/catalogo/produtos", pro: false },
      { name: "Categorias", path: "/admin/catalogo/categorias", pro: false },
      { name: "Cardápios", path: "/admin/catalogo/cardapios", pro: false },
    ],
  },
  {
    icon: <ListIcon />,
  ...
  },
  {
    ...
    name: "Gerenciamento",
    subItems: [
      { name: "Usuários", path: "/admin/gerenciamento/usuarios", pro: false },
      { name: "Grupos de Usuários", path: "/admin/gerenciamento/grupos", pro: false },
      { name: "Permissões de Acesso", path: "/admin/gerenciamento/permissoes", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    ...
    subItems: [
      ...
      { name: "Calendar", path: "/admin/calendar", pro: false },
