...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    name: "Gerenciamento",
    subItems: [
      { name: "Usuários", path: "/gerenciamento/usuarios", pro: false },
      { name: "Grupos de Usuários", path: "/gerenciamento/grupos", pro: false },
      { name: "Permissões de Acesso", path: "/gerenciamento/permissoes", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
