          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-gray-100 rounded-lg flex items-center justify-center flex-shrink-0 dark:bg-gray-700">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300">contato@cardapiodigital.com.br</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300">(11) 99999-9999</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300">São Paulo, SP - Brasil</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-600 dark:text-gray-300">Segunda a Sexta: 9h às 18h</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-8">
              <a
                href="#"
                className="w-12 h-12 rounded-lg flex items-center justify-center bg-gray-100 text-gray-700 transition-all hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              >
