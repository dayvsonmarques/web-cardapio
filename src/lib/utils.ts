...
/**
 * Format a Brazilian mobile phone as it is typed, toward "(XX) XXXXX-XXXX".
 * Non-digits are ignored and the value is capped at 11 digits.
 * @param value - Raw input value
 * @returns Partially or fully masked phone string
 */
...
/**
 * Validate a Brazilian mobile phone number (with DDD).
 * @param phone - Phone string with or without formatting
 * @returns true if it has 11 digits and the digit after the DDD is 9
 */
